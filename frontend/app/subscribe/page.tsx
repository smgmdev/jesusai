...
const TIERS = [
  {
    ...
    callsMonthly: '9 calls/month from the universe', callsAnnual: '104 calls/year from the universe',
  ...
  },
  {
    ...
    callsMonthly: '30 calls/month from the universe', callsAnnual: '365 calls/year from the universe',
  ...
  },
  {
    ...
    callsMonthly: '60 calls/month from the universe', callsAnnual: '730 calls/year from the universe',
